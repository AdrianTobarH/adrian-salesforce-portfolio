...
const translations = {
  en: {
    ...
    "headline": "Architect-Level Automation<br>for Enterprise Scale",
    ...
    "idx.hero.eyebrow": "Salesforce Platform Engineer",
    "idx.hero.sub": "Flow orchestration · Apex service layers · Enterprise integrations · Sales Cloud environments",
    ...
    "idx.diagram.panel.orchestration.principle": "Coordinate business processes declaratively while maintaining flexibility for admin-level iteration. Orchestration calls services — it does not contain business logic itself.",
    ...
    "idx.projects.card1.metricLabel": "routing time reduction",
    ...
    "idx.projects.card2.metricLabel": "adoption improvement",
    ...
    "idx.metrics.tag": "Impact",
    "idx.metrics.intro": "Architecture decisions measured through operational effectiveness outcomes.",
    "idx.metrics.card1.label": "Manual routing workload reduced via Flow automation",
    "idx.metrics.card1.domain": "⚙ Automation Speed",
    "idx.metrics.card2.label": "Executive dashboard visibility adoption improved",
    "idx.metrics.card2.domain": "◫ Executive Adoption",
    "idx.metrics.card3.label": "Reusable Named Credential architecture deployed across services",
    ...
    "pca.impact1": "Routing time reduction",
    ...
    "pca.b1.li1": "Manual case assignment causing 40%+ delay in first response times",
    ...
    "pca.b2.li2": "Scheduled Flow for time-based SLA monitoring and escalation triggers",
    ...
    "pca.b3.li3": "Multi-branch escalation via scheduled paths with wait elements",
    ...
    "pca.b6.li1": "40% reduction in average case routing time (manual → automated)",
    ...
    "plwc.impact1": "Adoption improvement",
    ...
    "plwc.b6.li1": "3× increase in executive dashboard adoption within 30 days of launch",
    ...
    "papi.impact2": "Secrets removed from Apex",
    ...
    "papi.b6.li1": "100% of API secrets removed from codebase — security audit passed",
    ...
    "padr.summary": "A complete Architecture Decision Record (ADR) — covering context, problem statement, constraints, decision rationale, solution layers, security model, scalability architecture, tradeoffs, and quantified business impact.",
    "padr.impact1": "Architecture Decision Record",
    "padr.impact2": "Routing reduction",
    ...
    "padr.b2.li1": "Manual routing created ownership delays averaging 40% above SLA target",
    ...
    "padr.b5.li4": "Scheduled Flow for SLA monitoring — automated escalation via wait paths",
    ...
    "padr.b8.li4": "Architecture supports horizontal queue expansion — estimated 10× current volume capacity",
    "padr.b9.num": "09 · Business Impact", "padr.b9.title": "Measured Outcomes",
    "padr.b9.li1": "Reduced manual assignment workload approximately 40% within first 30 days",
  ...
  es: {
    ...
    "headline": "Automatización Nivel Architect<br>para Escala Empresarial",
    ...
    "idx.hero.eyebrow": "Ingeniero de Plataforma Salesforce",
    "idx.hero.sub": "Orquestación de Flow · Capas de servicio Apex · Integraciones empresariales · Entornos Sales Cloud",
    ...
    "idx.diagram.panel.orchestration.principle": "Coordinar procesos de negocio de forma declarativa, manteniendo flexibilidad para la iteración a nivel de administración. La orquestación invoca servicios: no contiene lógica de negocio en sí misma.",
    ...
    "idx.projects.card1.metricLabel": "reducción en tiempo de enrutamiento",
    ...
    "idx.projects.card2.metricLabel": "mejora en adopción",
    ...
    "idx.metrics.tag": "Impacto",
    "idx.metrics.intro": "Decisiones de arquitectura medidas a través de resultados de efectividad operativa.",
    "idx.metrics.card1.label": "Carga de trabajo de enrutamiento manual reducida mediante automatización con Flow",
    "idx.metrics.card1.domain": "⚙ Velocidad de Automatización",
    "idx.metrics.card2.label": "Adopción de visibilidad en dashboards ejecutivos mejorada",
    "idx.metrics.card2.domain": "◫ Adopción Ejecutiva",
    "idx.metrics.card3.label": "Arquitectura de Named Credential reutilizable desplegada en todos los servicios",
    ...
    "pca.impact1": "Reducción en tiempo de enrutamiento",
    ...
    "pca.b1.li1": "La asignación manual de casos provoca más de un 40% de retraso en los tiempos de primera respuesta",
    ...
    "pca.b2.li2": "Scheduled Flow para el monitoreo de SLA basado en tiempo y los disparadores de escalamiento",
    ...
    "pca.b3.li3": "Escalamiento multirrama mediante rutas programadas con elementos de espera",
    ...
    "pca.b6.li1": "40% de reducción en el tiempo promedio de enrutamiento de casos (manual → automatizado)",
    ...
    "plwc.impact1": "Mejora en adopción",
    ...
    "plwc.b6.li1": "Aumento de 3× en la adopción del dashboard ejecutivo dentro de los 30 días posteriores al lanzamiento",
    ...
    "papi.impact2": "Secretos eliminados de Apex",
    ...
    "papi.b6.li1": "100% de los secretos de API eliminados del código: auditoría de seguridad aprobada",
    ...
    "padr.summary": "Un Registro de Decisión de Arquitectura (ADR) completo, que cubre el contexto, la declaración del problema, las restricciones, la justificación de la decisión, las capas de solución, el modelo de seguridad, la arquitectura de escalabilidad, las compensaciones y el impacto de negocio cuantificado.",
    "padr.impact1": "Registro de Decisión de Arquitectura",
    "padr.impact2": "Reducción de enrutamiento",
    ...
    "padr.b2.li1": "El enrutamiento manual generaba retrasos de propiedad en promedio un 40% por encima del objetivo de SLA",
    ...
    "padr.b5.li4": "Scheduled Flow para el monitoreo de SLA, con escalamiento automatizado mediante rutas de espera",
    ...
    "padr.b8.li4": "La arquitectura soporta la expansión horizontal de colas, con una capacidad estimada de 10× el volumen actual",
    "padr.b9.num": "09 · Impacto de Negocio", "padr.b9.title": "Resultados Medidos",
    "padr.b9.li1": "Redujo la carga de trabajo de asignación manual en aproximadamente un 40% dentro de los primeros 30 días",
  ...
  fr: {
    ...
    "headline": "Automatisation Niveau Architecte<br>pour Échelle Entreprise",
    ...
    "metricsTitle": "Impact des Métriques d'Architecture",
    "ctaTitle": "Construisons une Automatisation<br>Salesforce Entreprise Ensemble",
    "idx.hero.eyebrow": "Ingénieur Plateforme Salesforce",
    "idx.hero.sub": "Orchestration Flow · Couches de service Apex · Intégrations d'entreprise · Environnements Sales Cloud",
    ...
    "idx.diagram.panel.orchestration.principle": "Coordonner les processus métier de manière déclarative tout en conservant la flexibilité pour l'itération au niveau administrateur. L'orchestration appelle des services — elle ne contient pas elle-même la logique métier.",
    ...
    "idx.projects.card1.metricLabel": "réduction du temps de routage",
    ...
    "idx.projects.card2.metricLabel": "amélioration de l'adoption",
    ...
    "idx.metrics.tag": "Impact",
    "idx.metrics.intro": "Décisions d'architecture mesurées à travers des résultats d'efficacité opérationnelle.",
    "idx.metrics.card1.label": "Charge de travail de routage manuel réduite grâce à l'automatisation Flow",
    "idx.metrics.card1.domain": "⚙ Vitesse d'Automatisation",
    "idx.metrics.card2.label": "Adoption de la visibilité des tableaux de bord exécutifs améliorée",
    "idx.metrics.card2.domain": "◫ Adoption Exécutive",
    "idx.metrics.card3.label": "Architecture Named Credential réutilisable déployée sur tous les services",
    ...
    "pca.impact1": "Réduction du temps de routage",
    ...
    "pca.b1.li1": "L'assignation manuelle des cas provoque un retard de plus de 40 % sur les délais de première réponse",
    ...
    "pca.b2.li2": "Scheduled Flow pour le suivi des SLA basé sur le temps et les déclencheurs d'escalade",
    ...
    "pca.b3.li3": "Escalade multi-branches via des chemins planifiés avec éléments d'attente",
    ...
    "pca.b6.li1": "40 % de réduction du temps moyen de routage des cas (manuel → automatisé)",
    ...
    "plwc.impact1": "Amélioration de l'adoption",
    ...
    "plwc.b6.li1": "Augmentation de 3× de l'adoption du tableau de bord exécutif dans les 30 jours suivant le lancement",
    ...
    "papi.impact2": "Secrets supprimés d'Apex",
    ...
    "papi.b6.li1": "100 % des secrets API supprimés du code — audit de sécurité réussi",
    ...
    "padr.summary": "Un Registre de Décision d'Architecture (ADR) complet — couvrant le contexte, l'énoncé du problème, les contraintes, la justification de la décision, les couches de solution, le modèle de sécurité, l'architecture de scalabilité, les compromis et l'impact business quantifié.",
    "padr.impact1": "Registre de Décision d'Architecture",
    "padr.impact2": "Réduction du routage",
    ...
    "padr.b2.li1": "Le routage manuel créait des retards de propriété en moyenne 40 % au-dessus de l'objectif SLA",
    ...
    "padr.b5.li4": "Scheduled Flow pour le suivi des SLA — escalade automatisée via des chemins d'attente",
    ...
    "padr.b8.li4": "L'architecture prend en charge l'expansion horizontale des files d'attente — capacité estimée à 10× le volume actuel",
    "padr.b9.num": "09 · Impact Métier", "padr.b9.title": "Résultats Mesurés",
    "padr.b9.li1": "A réduit la charge de travail d'assignation manuelle d'environ 40 % au cours des 30 premiers jours",

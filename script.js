...
const translations = {
  en: {
    ...
    "idx.arch.intro": "Designing scalable Flow orchestration frameworks, reusable Apex service layers, and integration architectures across Sales Cloud environments. Focused on performance, governance alignment, and maintainable automation at scale.",
  ...
  es: {
    ...
    "idx.arch.intro": "Diseño de frameworks de orquestación Flow escalables, capas de servicio Apex reutilizables y arquitecturas de integración en entornos Sales Cloud. Enfocado en rendimiento, alineación de gobernanza y automatización mantenible a escala.",
  ...
  fr: {
    ...
    "idx.arch.tag": "Architecture",
    "idx.arch.intro": "Conception de frameworks d'orchestration Flow scalables, de couches de service Apex réutilisables et d'architectures d'intégration sur des environnements Sales Cloud. Axé sur la performance, l'alignement de gouvernance et l'automatisation maintenable à grande échelle.",
